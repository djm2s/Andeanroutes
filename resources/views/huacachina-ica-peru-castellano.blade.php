...
<head>
    ...
    <meta property="og:description"
        content="Conoce y disfruta de este tour en Huacachina, donde encontraremos un gran Oasis." />
    <meta property="og:url" content="https://andeanexclusive.com/huacachina-ica-peru-castellano">
                            ...
                            <nav class="main-nav">
                                <ul class="one-page-menu">
                                    ...
                                    <li id="display" class="menu-has-children">
                                        ...
                                        <ul>
                                            <li><a>Español</a></li>
                                            <li><a href="huacachina-ica-peru">Ingles</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="display2" class="menu-has-children">
                                        <a href="#">Es</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="huacachina-ica-peru">En</a>
                                    </li>
                                </ul>
                                                    ...
                                                    <div class='swiper-container'>
                                                        <div class='swiper-wrapper'>
                                                            <div class='swiper-slide'>
                                                                <div
                                                                    class='cover-text ph5 text-light text-center pv8 pvb0'>
                                    ...
                                    <div class="row" id="rowdjm">
                                        ...
                                        <div class="col-lg-6">
                                            <center>
                                                ...
                                                <div class='readmore'>
                                                    <a href="mailto:reservas@andeanexclusive.com" id='botondjm3'><i
                                                            class="fa fa-envelope-o"></i> Contáctenos</a>
                                                </div>
                                                </p>
                                            </center>
                                            <div id="separador"></div>
                                            ...
                                            <p>
                                                Vive una experiencia con adrenalina al máximo, recorriendo las inmensas
                                                dunas en el desierto de Ica.<br>
                                                A.M. o P.M. – Recojo desde su hotel o terrapuerto para llevarlos a las
                                                majestuosas dunas del desierto de Ica donde iniciaremos el tour de
                                                tubulares. Vive una experiencia con adrenalina al máximo, recorriendo
                                                las inmensas dunas en el desierto de Ica. Dentro del circuito está
                                                incluida la magnífica experiencia de deslizarte en una tabla y practicar
                                                sandboarding. Al finalizar el tour, visitaremos la Laguna de Huacachina.
                                            </p>
                                            <h5>INCLUYE:</h5>
                                            <p>
                                                Instructor español / inglés<br>
                                                Traslado in/out<br>
                                                Movilidad<br>
                                                Asistencia permanente<br>
                                                Sandboarding + Paseo en Buggies
                                            </p>
                                            <h5>NO INCLUYE:</h5>
                                            <p>
                                                Entrada S/ 10.00 soles por persona
                                            </p>
                                            <div id="separador"></div>
                                            ...
                                            <div class="form text-center">
                                                ...
                                                <div class="fb-like"
                                                    data-href="https://andeanexclusive.com/huacachina-ica-peru-castellano.php"
                                                            ...
                                                            <div class='travel-item'>
                                                                <div class='entry-img'>
                                                                    <a class='entry-link' href="arequipa-3-dias"><img
                                                                            srcset="img/thumbnail/arequipa-perú.JPG 1000w, img/thumbnail/arequipa-perú.JPG 500w"
                                                                ...
                                                                <div class='entry-info'>
                                                                    ...
                                                                    <div class='readmore'>
                                                                        <a href='arequipa-3-dias' class='button'>Leer
                                                                            más</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="wpb_wrapper">
                                                            <div class='travel-item'>
                                                                ...
                                                                <div class='entry-info'>
                                                                    ...
                                                                    <div class='readmore'>
                                                                        <a class='button'
                                                                            href="puerto-maldonado-español">Leer más</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
