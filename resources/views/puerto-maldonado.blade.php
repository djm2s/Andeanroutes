...
<head>
    ...
    <meta property="og:url" content="https://andeanexclusive.com/puerto-maldonado.php">
                            ...
                            <nav class="main-nav">
                                <ul class="one-page-menu">
                                    ...
                                    <li id="display" class="menu-has-children">
                                        ...
                                        <ul>
                                            <li><a href="puerto-maldonado-español">Español</a></li>
                                            <li><a>Ingles</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="display2" class="menu-has-children">
                                        <a href="puerto-maldonado-español"><img src="img/españa.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;
