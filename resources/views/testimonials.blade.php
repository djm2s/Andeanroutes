...
<head>
    ...
    <meta property="og:url" content="https://andeanexclusive.com/testimonials.html">
                            ...
                            <nav class="main-nav">
                                <ul class="one-page-menu">
                                    ...
                                    <li id="display" class="menu-has-children">
                                        ...
                                        <ul>
                                            <li><a href="testimonios">Español</a></li>
                                            <li><a>Ingles</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="col-sm-12">
                        <article class="blog-item blog-single">
                            <div class="entry-excerpt">
                                <div data-vc-full-width="true" data-vc-full-width-init="false" data-onepage-title="Home" data-onepage-slug="home" class="vc_row wpb_row vc_row-fluid testimonials vc_row-has-fill vc_row-o-full-height vc_row-o-columns-middle vc_row-o-content-middle vc_row-flex">
                                ...
                                <div data-onepage-title="Services" data-onepage-slug="services" class="vc_row wpb_row vc_row-fluid vc_custom_1461248392126">
                                    ...
                                    <div class="col-lg-8 text-center">
                                        ...
                                        <div class='tcontent'>“On behalf of all Blue Parallel team, I would like to thank you a million for all the hard and excellent work over the past 12 years . It has been a real pleasure to work with you and we always felt that we could count on you regardless of the day / time and regardless of how challenging the request was. We will miss you a lot as we almost felt you were part of our day -to day team. We wish you the best of luck, and we hope that our paths will again cross in the future.”
                                            <div id="separador"></div>
                                            <div id="separador"></div>
                                            <strong>Ann Alvarado</strong>
                                            <div id="circulo2"></div>
                                            <div class='stars'><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i>
                                            </div>
                                            <div class='tcontent'>“Thank you very much for you attention. We enjoy a lot theompany of Andean Exclusive staff. I hope to see you agains to soon in my next visit to Perú.”
                                            </div>
                                            ...
                                            <div class='tcontent'>“Dear Carmen, Marleny, Luisa and Raquel:<br> I hope you are good I just wanted to tell you from the date my load left as a Travel Planner in Aracari. Keep in touch with the company and I hope we can find again in the future It has been a pleasure working together with Andean Exclusive team and I thank you very much for your professionalism, patience, support and dedication. I leave my contact information”
                                            </div>
                                            <div id="separador"></div>
