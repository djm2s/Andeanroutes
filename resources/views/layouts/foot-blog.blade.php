                    ...
                    <div class='col-sm-6 col-md-4 footer-column-4' style="padding-bottom: 35px">
                        ...
                        <div id="tt_sociallinkswidget-4" class="footer_widget widget widget_social">
                            <div class="social-links">
                                <a href="https://www.facebook.com/AndeanExclusiveTours" target="_blank" rel="nofollow"><i  class="fa fa-facebook fa-2x"></i></a>
                                <a href="https://twitter.com/ReservasAndean" target="_blank" rel="nofollow"><i  class="fa fa-twitter fa-2x"></i></a>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <div class="widget">
                                    <p>Copyright 2019 &copy; Andean Exclusive Tours | All Rights Reserved | Designed by <a href="https://www.facebook.com/DjmWebMaster" id="afoot" target="_blank" rel="nofollow">DJM2</a>
                                </p>
                                </div>
                            </div>
                        </div>
