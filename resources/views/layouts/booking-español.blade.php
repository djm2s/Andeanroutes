<!-----Booking---------->
<h4 style="padding-top: 13px">Reserve Ahora!</h4>
<form action="{{ route('mensaje02') }}" method="post" role="form" class="book1">
	...
	<div class="form-group col-lg-12">
		...
		<textarea class="form-control" name="mensaje" id="mensaje" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Escriba acá su consulta:"></textarea>
		<div class="validation"></div>
	</div>
	<center>
