                            ...
                            <nav class="main-nav">
                                <ul class="one-page-menu">
                                    ...
                                    <li id="display" class="menu-has-children">
                                        ...
                                        <ul>
                                            <li><a href="blog-español">Español</a></li>
                                            <li><a>Ingles</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="display2" class="menu-has-children">
                                        <a href="blog-español"><img src="img/españa.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="col-sm-12">
                        <article class="blog-item blog-single">
                            <div class="entry-excerpt">
                                <div data-vc-full-width="true" data-vc-full-width-init="false" data-onepage-title="Home" data-onepage-slug="home" class="vc_row wpb_row vc_row-fluid adventure vc_row-has-fill vc_row-o-full-height vc_row-o-columns-middle vc_row-o-content-middle vc_row-flex">
                                                            ...
                                                            <div class="wpb_wrapper">
                                                                 <div class='travel-item'>
                                                                    ...
                                                                    <div class='entry-info'>
                                                                        <h3>Trekking Choquequirao (4 días)</h3><br>
                                                                        <div class='readmore'>
